...
public class MaterialRenderInfoProvider extends AbstractMaterialRenderInfoProvider {
  ...
  protected void addMaterialRenderInfo() {
    ...
    buildRenderInfo(MaterialIds.ardite).color(0xD06F23).fallbacks("metal");
    ...
    buildRenderInfo(ToolBuildHandler.getRenderMaterial(3)).color(0xD06F23).texture(MaterialIds.ardite).fallbacks("metal");
    buildRenderInfo(ToolBuildHandler.getRenderMaterial(4)).color(0x9261cc).texture(MaterialIds.manyullyn).fallbacks("metal");
    buildRenderInfo(ToolBuildHandler.getRenderMaterial(5)).color(0xF98648).texture(MaterialIds.copper).fallbacks("metal");
  }
