...
public class MaterialRecipeProvider extends BaseRecipeProvider implements IMaterialRecipeHelper {
  ...
  private void addMaterialItems(Consumer<IFinishedRecipe> consumer) {
    ...
    metalMaterialRecipe(consumer, MaterialIds.ardite, folder, "ardite", false);
    // tier 4
  ...
  private void addMaterialSmeltery(Consumer<IFinishedRecipe> consumer) {
    ...
    materialMeltingCasting(consumer, MaterialIds.ardite,        TinkerFluids.moltenArdite,        true,  folder);
    ...
    materialMeltingComposite(consumer, MaterialIds.string, MaterialIds.darkthread, TinkerFluids.moltenObsidian, FluidValues.GLASS_PANE,  false, folder);
    // tier 4
    ...
    materialMeltingComposite(consumer, MaterialIds.leather, MaterialIds.ancientHide, TinkerFluids.moltenDebris, FluidValues.INGOT, false, folder);
